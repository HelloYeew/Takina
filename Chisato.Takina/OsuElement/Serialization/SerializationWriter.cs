...
/// <summary>
/// SerializationWriter is a <see cref="BinaryWriter"/> for writing data to stream.
/// </summary>
public class SerializationWriter : BinaryWriter
{
    ...
    public void Write<TKey, TValue>(Dictionary<TKey, TValue>? dictionary) where TKey : notnull
    {
        if (dictionary == null)
        {
            Write(-1);
